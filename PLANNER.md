...
- [ ] Step 5: Page section editor (Home/Products/Privacy/Contact copy + backgrounds) — `/studio/pages` is currently a placeholder, though `content-schemas.ts` + seeded data are ready for it
